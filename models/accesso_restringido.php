...
class ControlAcceso {
    ...
    public function verificarAcceso($pagina_actual) {
        ...
        $permisos = [
            ...
            8 => ['index.php','validacion_incidencia.php', 'dashboard_docentes.php','form_incidencias.php', 'dashboard_carreras.php','form_horario.php','recursos_humanos_empleados.php','formulario_usuario.php','desarrollo_academico_docentes.php','form_materia.php','form_carrera.php','formulario_grupo.php','form_usuarios-carreras.php', 'form_edificio.php']
        ];
