            ...
            <div class="row">
              ...
              <div class="col-md-8 carta_Informacion">
                <div class="card p-5 box-shadow-div large-text h-100">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <p><strong class="text-green">Año de Validación:</strong><br>
                        <?= $carreraData['fecha_validacion'] ?></p>
                    ...
                    <div class="col-md-6">
                      ...
                      <p><strong class="text-green">Organismo certificador:</strong><br>
                        <?= $carreraData['organismo_auxiliar'] ?? 'N/A' ?></p>
                    </div>
                  </div>
                  <p><strong class="text-green">Acreditación:</strong><br>
                    <?= $carreraData['fecha_inicio_validacion'] ?>
                ...
                <div class="container-fluid p-3">
                  <div class="row">
                    <div class="col-12 col-md-6 carta_Informacion">
                      <div class="card shadow mb-4 box-shadow-div h-100 carta_Informacion">
                        ...
                        <div class="card-body text-center d-flex justify-content-center align-items-center"
                          ...
                          <div id="donutChart6" class="chart-container"
                            style="width: 100%; max-width: 280px; height: 250px;"></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mt-5 carta_Informacion">
                      <form method="POST" class="mb-4">
                        <div class="form-group">
                          ...
                          <select name="sexo" id="sexo" class="form-control" onchange="this.form.submit()">
                            <option value="0" <?php echo $sexoSeleccionado == 0 ? 'selected' : ''; ?>>Selecciona un sexo
                            </option>
                      ...
                      <div class="table-section p-3 border rounded box-shadow-div carta_Informacion"
                        ...
                        <div class="card-body text-center">
                          ...
                          <div id="incidencias-container" style="overflow-y: auto;">
                            <table class="table table-striped table-bordered" id="tabla-incidencias">
                              <thead class="thead-dark"
                                style="position: sticky; top: 0; background-color: #343a40; color: white; z-index: 2;">
                                <tr>
                  ...
                  <div class="row">
                      ...
                      <div class="row my-4">
                        <div class="col-md-12">
                          <div class="chart-box rounded">
                            <canvas id="columnChartTipo1"></canvas>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12 carta_Informacion">
                      <div class="table-section p-6 border rounded box-shadow-div h-100 carta_Informacion">
                        <div class="d-flex justify-content-between align-items-center mb-3 carta_Informacion">
                          <h4 class="mb-0 text-green carta_Informacion">Acreditaciones Pedagógicas</h4>
                        </div>
                        <table class="table table-striped carta_Informacion">
                          ...
                          <tbody>
                            <?php if (!empty($certificacionesTipo1)): ?>
                  ...
                  var donutChart = new Chart(ctx, {
                    ...
                    data: {
                      ...
                      datasets: [{
                        ...
                        hoverBackgroundColor: ['#004d00', '#1e7e1e', '#28a745'],
                        hoverOffset: 10
                      }]
                    },
                    options: {
                      ...
                      <tbody>
                        <?php if ($maestros): ?>
                          <?php foreach ($maestros as $maestroscarrera): ?>
                            <tr>
                              <td>
                                <?php echo htmlspecialchars($maestroscarrera['nombre_usuario'] . ' ' . $maestroscarrera['apellido_p'] . ' ' . $maestroscarrera['apellido_m']); ?>
                              </td>
