...
<body class="vertical  light  ">
  ...
  <div class="card shadow mb-4">
    <div class="card-body">
      <div class="d-flex justify-content-center align-items-center mb-3 col">
        <p class="titulo-grande"><strong>Asignacion de Grupo a Profesor</strong></p>
      </div>
        ...
        <div class="row mb-3">
          <div class="col-md-4">
            <div class="form-group">
              <label for="usuario" class="form-label">Profesor:</label>
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <div class="d-flex justify-content-center align-items-center mb-3 col">
          <p class="titulo-grande"><strong>Asignaciones de Grupos</strong></p>
        </div>
        <div class="row my-4">
          <!-- Small table -->
          <div class="col-md-12">
